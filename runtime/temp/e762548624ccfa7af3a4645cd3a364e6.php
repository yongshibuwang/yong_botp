<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:47:"F:\wzpl./application/index\view\about\info.html";i:1542803510;s:48:"F:\wzpl\application\index\view\father\index.html";i:1542803396;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <aside class="right">
        ...
        <div class="news">
            ...
            <ul class="rank">
                ...
                <li><a href="<?php echo url('Index/info',['id'=>$no['id']]); ?>" title="<?php echo $no['title']; ?>" target="_blank"><?php echo $no['title']; ?></a></li>
            ...
            <ul class="paih">
                ...
                <li><a href="<?php echo url('Index/info',['id'=>$ro['id']]); ?>" title="<?php echo $ro['title']; ?>" target="_blank"><?php echo $ro['title']; ?></a></li>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </ul>
        </div>
        <div class="visitors">
