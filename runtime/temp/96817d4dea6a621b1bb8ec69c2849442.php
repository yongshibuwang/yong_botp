<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:59:"F:\plant\public/../application/zhyong\view\tables\save.html";i:1548576777;s:50:"F:\plant\application\zhyong\view\Father\index.html";i:1555480675;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            <div class="widget-head am-cf">
                                <div class="widget-title am-fl" onclick="history.back(-1)">文章管理->添加</div>
                            ...
                            <div class="widget-body am-fr">
                                <form class="am-form tpl-form-border-form tpl-form-border-br" id="form1">
                                    <div class="am-form-group">
                                        <label for="user-phone" class="am-u-sm-3 am-form-label">所属类别 <span class="tpl-form-line-small-title">Author</span></label>
                                        <div class="am-u-sm-9">
                                            <select data-am-selected="{searchBox: 1}" name="kind" style="display: none;">
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" name="title" style="width: 90%;" class="tpl-form-input" id="user-name" placeholder="请输入标题文字">
                                        </div>
                                    </div>
                                    <div class="am-form-group">
                                        <label for="describe" class="am-u-sm-3 am-form-label">描述 <span class="tpl-form-line-small-title">Title</span></label>
                                        <div class="am-u-sm-9">
                                            <textarea name="describe" id="describe" style="width: 90%;" class="tpl-form-input" cols="10" rows="3" placeholder="请输入描述"></textarea>
                                        </div>
                                    </div>
                                    <div class="am-form-group">
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" name="author" style="width: 90%;" class="tpl-form-input" id="user-name" placeholder="请输入作者">
                                        </div>
                                    </div>
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <select name="pid" id="pid">
                                                ...
                                                <option value="<?php echo $lao['id']; ?>"  style="background-color:#36c6d3;color:#fff"><?php echo $lao['name']; ?></option>
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9" id="">
                                            <textarea class="" name="content" rows="10" style="width: 90%;"  id="editor" placeholder="请输入文章内容"></textarea>
                                        </div>
                                    </div>
                                    <div class="am-form-group">
...
//            console.log(picArr)
    ...
    $('.submit_up').click(function(){
        editor.sync();
        if(!$('[name=kind] option:selected').val()){layer.msg('请选择所属类别',{time:800});$('[name=kind]').focus();return false;};
        ...
        var a = {
            'kind':$('[name=kind] option:selected').val(),
        ...
        $.post("<?php echo url('Tables/save'); ?>",{data:a},function(data){
            console.log(data);
            if(data.code){
