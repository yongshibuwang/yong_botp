<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:48:"F:\yong/application/zhyong\view\zhyong\role.html";i:1554865538;s:49:"F:\yong\application\zhyong\view\Father\index.html";i:1547089984;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
                        ...
                        <div class="widget am-cf">
                            <div class="widget-head am-cf">
                                <div class="widget-function am-fr" style="margin-right: 3%;">
                                    <a href="<?php echo url('Zhyong/roleadd'); ?>" class="">添加</a>
                                </div>
                            </div>
                                        ...
                                        <tr class="gradeX">
                                            ...
                                            <td>
                                                <div class="tpl-table-black-operation">
                                                    <a href="<?php echo url('Zhyong/roleedit',['id'=>$vo['id']]); ?>">
