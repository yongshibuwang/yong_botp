<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:58:"F:\yongshibuwang./application/index\view\oftenweb\web.html";i:1543569139;s:58:"F:\yongshibuwang\application\index\view\father\father.html";i:1543569139;}*/ ?>
<!doctype html>
<html>
<head>
        ...
        <div class="template" style="position: relative;right: 12px;">
            <div class="box">
                <ul style="width: 80%;position: relative;left: 6px;">
                    ...
                    <li style="height: 152px;"><a href="<?php echo $lo['web_address']; ?>" target="_blank" >
                        <img style="width: 160px;height: 92px;" src="<?php echo $lo['img']; ?>"></a>
                        <span class="web_color"><?php echo $lo['name']; ?></span>
