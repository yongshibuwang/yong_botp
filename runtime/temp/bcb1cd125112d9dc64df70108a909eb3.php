<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:53:"F:\wzpl./application/index\view\about\php_option.html";i:1542803695;s:48:"F:\wzpl\application\index\view\father\index.html";i:1542803396;}*/ ?>
<!doctype html>
<html>
<head>
...
<header>
    ...
    <nav class="topnav" id="topnav">
        ...
        <a href="<?php echo url('About/phpOption'); ?>" id="<?php echo $gl==2?'topnav_current':''; ?>"><span>后端文章</span><span class="en">after end</span></a>
        <a href="<?php echo url('About/htmlOption'); ?>" id="<?php echo $gl==3?'topnav_current':''; ?>"><span>前端文章</span><span class="en">leading end</span></a>
...
<article class="blogs">
<h1 class="t_nav"><span>“慢生活”不是懒惰，放慢速度不是拖延时间，而是让我们在生活中寻找到平衡。</span><a href="/" class="n1">网站首页</a><a href="/" class="n2">后端文章</a></h1>
<div class="newblog left">
    <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$lo): $mod = ($i % 2 );++$i;?>
        ...
        <ul class="nlist">
            ...
            <a title="阅读全文" href="<?php echo url('About/info',['id'=>$lo['id']]); ?>" class="readmore">阅读全文>></a>
        </ul>
        <div class="line"></div>
...
<aside class="right">
   <div class="rnav">
      <ul>
       ...
       <li class="rnav2"><a href="/newsfree/">个人笔记</a></li>
       <li class="rnav3"><a href="/web/" >留言板</a></li>
       <li class="rnav4"><a href="/newshtml5/" >常用网站</a></li>
     </ul>      
    </div>
<div class="news">
<h3>
    ...
    <ul class="rank">
        ...
        <li><a href="<?php echo url('About/info',['id'=>$no['id']]); ?>" title="<?php echo $no['title']; ?>"><?php echo $no['title']; ?></a></li>
        <?php endforeach; endif; else: echo "" ;endif; ?>
    </ul>
    <h3 class="ph">
      <p>点击<span>排行</span></p>
    ...
    <ul class="paih">
        ...
        <li><a href="<?php echo url('About/info',['id'=>$ro['id']]); ?>" title="<?php echo $ro['title']; ?>"><?php echo $ro['title']; ?></a></li>
        <?php endforeach; endif; else: echo "" ;endif; ?>
    </ul>
    </div>
    <div class="visitors">
