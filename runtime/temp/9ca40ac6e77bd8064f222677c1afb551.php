<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:51:"F:\wzpl./application/zhyong\view\tables\tables.html";i:1542939014;s:49:"F:\wzpl\application\zhyong\view\Father\index.html";i:1542608302;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
                        ...
                        <div class="widget am-cf">
                            <div class="widget-head am-cf">
                                ...
                                <div class="widget-title am-fl tpl-table-black-operation">
                                    <a href="javascript:;" style="<?php echo $type==1?'color:#fff;':''; ?> padding:6px 8px; border-radius: 4%;font-size: 14px;margin-right: 6px;"  onclick="t_type(1)">未审核</a>
                                    <a href="javascript:;" style="<?php echo $type==2?'color:#fff;':''; ?> padding:6px 8px; border-radius: 4%;font-size: 14px;margin-right: 6px;"  onclick="t_type(2)">已通过</a>
                                    <a href="javascript:;" style="<?php echo $type==3?'color:#fff;':''; ?> padding:6px 8px; border-radius: 4%;font-size: 14px;margin-right: 6px;"  onclick="t_type(3)">未通过</a>
                                </div>
                                    <input type="hidden" name="type" value="<?php echo $type; ?>"/>
                                    <input type="submit" id="tijiao" style="display: none;"/>
                                </form>
                                <div class="widget-function am-fr" style="margin-right: 3%;">
                                    <a href="<?php echo url('Tables/save'); ?>" class="">添加</a>
