<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"F:\plant\public/../application/zhyong\view\leaveword\user_leavewrod.html";i:1555047577;s:50:"F:\plant\application\zhyong\view\Father\index.html";i:1555480675;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
                        ...
                        <div class="widget am-cf">
                            <div class="widget-head am-cf">
                                ...
                                <div class="widget-function am-fr" style="margin-right: 3%;">
                                    <!--<a href="<?php echo url('Leaveword/add'); ?>" class="">添加</a>-->
                            ...
                            <div class="widget-body  widget-body-lg am-fr">
                                <table width="100%" class="am-table am-table-compact tpl-table-black " id="">
                                    <thead>
                                        <tr>
                                            <th width="">用户名</th>
                                            <th width="60%"  style="text-align: center">留言内容</th>
                                            <th>时间</th>
                                            <th>操作</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    <?php if(is_array($leave) || $leave instanceof \think\Collection || $leave instanceof \think\Paginator): $i = 0; $__LIST__ = $leave;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                        <tr class="gradeX">
                                            <td><?php echo $vo['user_name']; ?></td>
                                            <td width="60%"><?php echo $vo['content']; ?></td>
