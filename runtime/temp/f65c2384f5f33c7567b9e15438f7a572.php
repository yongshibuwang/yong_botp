<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:50:"F:\wzpl./application/admin\view\tables\tables.html";i:1542271583;s:48:"F:\wzpl\application\admin\view\Father\index.html";i:1542262535;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
                        ...
                        <div class="widget am-cf">
                            <div class="widget-head am-cf">
                                ...
                                <div class="widget-title am-fl tpl-table-black-operation">
                                    ...
                                    <a href="javascript:;" style="padding:6px 8px; border-radius: 4%;font-size: 18px;margin-right: 6px;"  onclick="t_type(2)">已通过</a>
                                    <a href="javascript:;" style="padding:6px 8px; border-radius: 4%;font-size: 18px;margin-right: 6px;"  onclick="t_type(3)">未通过</a>
                                </div>
