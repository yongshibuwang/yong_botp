<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:55:"F:\plant/application/index\view\article\php_option.html";i:1555039742;s:50:"F:\plant\application\index\view\Father\father.html";i:1552640965;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
            ...
            <div class="widget widget_sentence">
                ...
                <ul>
                    <?php if($label): if(is_array($label) || $label instanceof \think\Collection || $label instanceof \think\Paginator): $i = 0; $__LIST__ = $label;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$loo): $mod = ($i % 2 );++$i;?>
                        <li><a href="<?php echo url('Article/phpOption',['pid'=>$loo['id']]); ?>"><?php echo $loo['name']; ?> </a></li>
