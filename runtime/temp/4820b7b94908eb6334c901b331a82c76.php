<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:52:"F:\yong/application/zhyong\view\zhyong\roleedit.html";i:1554872511;s:49:"F:\yong\application\zhyong\view\Father\index.html";i:1547089984;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
                    ...
                    <div class="widget-body am-fr">
                        <form class="am-form tpl-form-border-form tpl-form-border-br" id="form1">
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9" style="margin-top: 3%;" id="right_item">
...
<script>
    ...
    $('.submit_up').click(function(){
        ...
        $.ajax({
            url:"<?php echo url('Zhyong/roleedit'); ?>",
            type:"POST",
            data:form,
            processData:false,
            contentType:false,
