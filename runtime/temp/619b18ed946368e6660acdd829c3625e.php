<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:56:"F:\plant/application/index\view\article\html_option.html";i:1555039742;s:50:"F:\plant\application\index\view\Father\father.html";i:1552640965;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
...
<head>
    ...
    <!--<link rel="stylesheet" type="text/css" media="screen" href="/public/static/index/css/bootstrap.min1.css" />-->
    <link rel="stylesheet" type="text/css" media="screen" href="https://cdn.bootcss.com/bootstrap/3.3.7/css/bootstrap.min.css" />
    <link rel="stylesheet" href="/public/static/index/css/style1.css">
</head>
...
<div class="container">
    ...
    <div class="banner introBanner" style="background: url(/public/static/index/images/banner_top.jpg) top center;width: 100%;background-size:cover;">
        <section class="box">
            <ul class="texts">
                <p>好想给你打一辈子辅助</p>
        ...
        <div class="sidebar">
            ...
            <div class="widget widget_sentence">
                ...
                <ul>
                    ...
                    <li><a href="<?php echo url('Article/htmlOption',['pid'=>$loo['id']]); ?>"><?php echo $loo['name']; ?> </a></li>
...
<div class="footer">
    <div class="container"  style="height: 22px;">
        <p style="height: 22px;"><?php echo $selfWebInfo['intro']; ?>-  <a href="https://new.cnzz.com/v1/login.php?siteid=5329134">网站统计<img style="width: 40px;height: 10px;display: inline;" src="/public/static/index/images/2.gif"></a></p>
    </div>
</div>
</body>
</html>
