<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:60:"G:\PHP-study\myling./application/admin\view\tables\save.html";i:1542206376;s:60:"G:\PHP-study\myling\application\admin\view\Father\index.html";i:1542206279;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
    ...
    <i class="am-icon-cloud-upload"></i> 添加封面图片</button>
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9" id="">
                                            <textarea class="" rows="10" id="editor_id" placeholder="请输入文章内容"></textarea>
                                        </div>
                                    </div>
