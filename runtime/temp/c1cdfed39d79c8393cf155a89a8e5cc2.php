<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:61:"F:\plant\public/../application/zhyong\view\tables\gossip.html";i:1555050833;s:50:"F:\plant\application\zhyong\view\Father\index.html";i:1555480675;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
                        ...
                        <div class="widget am-cf">
                            <div class="widget-head am-cf">
                                ...
                                <div class="widget-function am-fr" style="margin-right: 3%;">
                                    <a href="<?php echo url('Tables/pid',['type'=>3]); ?>" class="">文章标签</a>
                                    <a href="<?php echo url('Tables/save',['type'=>3]); ?>" class="">添加</a>
                                        ...
                                        <tr class="gradeX">
                                            ...
                                            <td>
                                                <div class="tpl-table-black-operation">
                                                    <a href="<?php echo url('Tables/edit',['id'=>$vo['id'],'type'=>3]); ?>">
...
<script>
    ...
    function del_article(id){
        layer.confirm('确认要删除吗？', function () {
            $.post("<?php echo url('del_article',['type'=>3]); ?>",{id:id},function(data){
                if(data.code){
