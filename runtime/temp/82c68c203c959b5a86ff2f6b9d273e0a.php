<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:46:"F:\yong/application/index\view\index\info.html";i:1547106836;s:48:"F:\yong\application\index\view\Father\index.html";i:1547110307;}*/ ?>
<!doctype html>
<html>
<head>
...
<header>
    ...
    <nav class="topnav" id="topnav">
        ...
        <?php else: ?>
            <a href="<?php echo url('Index/index'); ?>" style="color: #000;"><span>首页</span><span class="en">Protal</span></a>
            <a href="<?php echo url('Article/phpOption'); ?>" ><span>后端文章</span><span class="en">after end</span></a>
            <a href="<?php echo url('Article/htmlOption'); ?>"><span>前端文章</span><span class="en">leading end</span></a>
            <!--<a href="moodlist.html" id="<?php echo $gl==4?'topnav_current':''; ?>"><span>碎言碎语</span><span class="en">Doing</span></a>-->
            <!--<a href="share.html" id="<?php echo $gl==5?'topnav_current':''; ?>"><span>分享</span><span class="en">Share</span></a>-->
            <a href="<?php echo url('Oftenweb/web'); ?>" ><span>常用网站</span><span class="en">Share</span></a>
            <a href="<?php echo url('Article/gossip'); ?>"><span>文章随笔</span><span class="en">Learn</span></a>
        <?php endif; ?>
...
<article class="blogs">
    ...
    <aside class="right">
        ...
        <div class="visitors">
            <h3>
                <p style="width: 106px;">最近访客<em style="color: red;">（<?php echo $accessNum; ?>）</em></p>
            </h3>
...
<footer>
    <p><a href="http://www.zhyong.top/" target="_blank" title="一个很有趣的油腻大叔"><?php echo $selfWebInfo['intro']; ?></a> -  <a href="/">网站统计</a></p>
</footer>
