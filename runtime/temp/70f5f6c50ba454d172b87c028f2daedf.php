<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:58:"F:\plant\public/../application/zhyong\view\zhyong\add.html";i:1547020021;s:50:"F:\plant\application\zhyong\view\Father\index.html";i:1555480675;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
                            ...
                            <div class="widget-body am-fr">
                                <form class="am-form tpl-form-border-form tpl-form-border-br" id="form1">
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" name="rolename" style="width: 40%;" class="tpl-form-input" id="role-name" placeholder="请输入标题文字">
                                        </div>
                                    </div>
                                    <div class="am-form-group">
                                        <label for="password" class="am-u-sm-3 am-form-label">管理密码 <span class="tpl-form-line-small-title">Password</span></label>
                                        <div class="am-u-sm-9">
                                            <input type="text" name="password" style="width: 40%;" class="tpl-form-input" id="password" placeholder="请输入管理密码">
                                        </div>
                                    </div>
                                    <div class="am-form-group" >
