<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:61:"F:\plant\public/../application/zhyong\view\tables\pidadd.html";i:1548571715;s:50:"F:\plant\application\zhyong\view\Father\index.html";i:1555480675;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
                    ...
                    <div class="widget-body am-fr">
                        <form class="am-form tpl-form-border-form tpl-form-border-br" id="form1">
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <input type="text" id="name" name="name" style="width: 40%;" class="tpl-form-input" placeholder="请输入便签名称">
                                </div>
                            </div>
