...
function setImagePreviews(docObj) {
    var butt_obj = document.getElementById("look_toux");
    //console.log(butt_obj);
    var fileList = docObj.files;
    for (var i = 0; i < fileList.length; i++) {
        if (docObj.files && docObj.files[i]) {
            butt_obj.style.backgroundImage="url("+window.URL.createObjectURL(docObj.files[i])+")";
        }
    }
}
